...
//------------------------------------------------------------------------------------
$('#inner-post-sidebar--0-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
    },
...
$('#inner-post-sidebar--0-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#inner-post-sidebar--0-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#inner-post-sidebar--0-form').find('[type=submit]').button('reset');
            }
        });
    } else {
